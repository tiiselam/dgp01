...
return(
	select case when @TRANSICION = 'GENERA_PREFACTURA' and isnull(li.DOCSTATUS, 'INICIO')= 'INICIO' THEN	1
			...
			case when @TRANSICION = 'GENERA_PREFACTURA' and isnull(li.DOCSTATUS, 'INICIO')= 'INICIO' THEN	'INICIO->LISTO Transición OK.'
				when @TRANSICION = 'ENVIAR_A_GP'and li.DOCSTATUS = 'LISTO' THEN								'LISTO->INTEGRADO Transición OK.'
				when @TRANSICION = 'ELIMINA_FACTURA_EN_GP' and li.DOCSTATUS = 'INTEGRADO' THEN				'INTEGRADO->LISTO Transición OK.'
